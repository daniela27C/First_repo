...
#functie ajutatoare pentru wait explicit
    def wait_for_element_presence(self, locator, seconds):
        wait = WebDriverWait(self.driver, seconds)    #wit explicit care primeste ca parametri: driverul,numar maxim de sec pe care ar trebui sa asteote
        wait.until(EC.visibility_of_element_located(locator))    #pe acel wait apelam functia until care primeste o conditie care aici spune astepti pana cand elementul devine visibil

#verifica ca elementul este acolo dar nu este afisat
